...
{
    public class DelimitedDataProvider : ISourceDataProvider
    {
        ...
        public DelimitedDataProvider(string filename)
        {
            SourceInfo = new DatasourceInfo { Connection = filename };
        }
        public DelimitedDataProvider(DatasourceInfo sourceInfo)
        {
